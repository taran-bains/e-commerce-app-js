/*
 * Name: Taran Bains, Prince Wang
 * Date: November 4, 2023
 * Section: CSE 154 AA, AD
 *
 * This is the JS to apply behavior to the EV commerce site.
 * It handles the page switching between the user sign in page
 * and the main page, and the selling products' features.
 */
